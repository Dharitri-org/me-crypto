...
import (
	...
	"github.com/Dharitri-org/me-core/hashing"
	"github.com/Dharitri-org/me-crypto"
	"github.com/Dharitri-org/me-crypto/mock"
	"github.com/Dharitri-org/me-crypto/signing"
	"github.com/Dharitri-org/me-crypto/signing/mcl"
	llsig "github.com/Dharitri-org/me-crypto/signing/mcl/multisig"
	"github.com/Dharitri-org/me-crypto/signing/multisig"
...
func TestNewBLSMultisig_NilPrivKeyShouldErr(t *testing.T) {
	...
	ownIndex := uint16(3)
	_, _, pubKeys, kg, llSigner := generateMultiSigParamsBLS(4, ownIndex)
...
func TestNewBLSMultisig_NilPubKeysShouldErr(t *testing.T) {
	...
	ownIndex := uint16(3)
	privKey, _, _, kg, llSigner := generateMultiSigParamsBLS(4, ownIndex)
...
func TestNewBLSMultisig_NilKeyGenShouldErr(t *testing.T) {
	...
	ownIndex := uint16(3)
	privKey, _, pubKeys, _, llSigner := generateMultiSigParamsBLS(4, ownIndex)
